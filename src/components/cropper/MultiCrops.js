...
/**
 * Renders each box according its coordinates
 */
class MultiCrops extends Component {
    ...
    // generates a temp id for each box
    id = shortid.generate()
    ...
    /**
     * Get the cursor position in order to set the position
     */
    getCursorPosition = (e) => {
    ...
    /**
     * Start the drag position in order to create the element
     */
    handleMouseDown = (e) => {
    ...
    /**
     * Resize and set the element according x,y coordinate
     */
    handleMouseMove = (e) => {
    ...
    render() {
        ...
        return (
            <div
                ...
                onMouseDown={this.props.toolbar.allowCreateNewBox ? this.handleMouseDown : null}
